...
(**
Check is_not_div_by_zero.
is_not_div_by_zero
     : int64 -> M bool
*)

Section Is_not_div_by_zero.
  ...
  Definition f : arrow_type args (M state.state res) := is_not_div_by_zero.

  (* [fn] is the Cligth function which has the same behaviour as [f] *)
  Definition fn: Clight.function := f_is_not_div_by_zero.
  ...
  Instance correct_function_is_not_div_by_zero : forall a, correct_function _ p args res f fn ModNothing true match_state match_arg_list match_res a.
  Proof.
    correct_function_from_body args.
    correct_body.

    unfold f. unfold is_not_div_by_zero.
    correct_forward.
    ...
    unfold eval_inv, match_res, state.is_not_div_by_zero'.
    unfold bool_correct, Val.of_bool.
    unfold BinrBPF.get_immediate, Int.cmp, rBPFValues.int64_to_sint32.
...
End Is_not_div_by_zero.

Existing  Instance correct_function_is_not_div_by_zero.
